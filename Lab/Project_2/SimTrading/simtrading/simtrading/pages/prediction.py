...
def render_prediction_page(dataset_bundle: DatasetBundle, model_name: str) -> None:
    ...
    st.plotly_chart(make_prediction_figure(dataset_bundle.predictions), use_container_width=True)
    ...
    st.dataframe(dataset_bundle.predictions.tail(20), use_container_width=True)
