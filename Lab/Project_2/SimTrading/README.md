...
This repository already includes a local `config/datasets.yaml` for the checked-in Project 2 data and prediction files. If those local artifacts are regenerated, update this YAML directly with the new local paths.
